;/*!/components/points/js/points.es6*/
"use strict";
...
(function ($, win) {
  ...
  //模态框模型选择器对象
  var ModelSelection = function ModelSelection(options) {
  ...
  ModelSelection.prototype = {
    init: function init() {
      ...
      $script2 = '<script src="/static/dist/comm/comm_20160313.js"></script>', $css2 = '<link rel="stylesheet" href="/static/dist//comm/comm_20160313.css" />';
  ...
  var Project = {
    ...
    showInModel: function showInModel(id, type) {
      var _this = this;
    ...
    zoomModel: function zoomModel(ids, box) {
      //定位
  ...
  var CommApi = {
    ...
    checkLogin: function checkLogin(appkey, token) {
    ...
    setCookies: function setCookies(cookis) {
    ...
    getCookie: function getCookie(name, cookis) {
    ...
    delCookie: function delCookie(name) {
      ...
      if (cval != null) document.cookie = name + "=" + cval + ";expires=" + exp.toGMTString() + ";domain=" + window.location.host.substring(window.location.host.indexOf(".")) + ";path=/";
    }
