...
App.Console = {
	...
	//发起发版
	versionComm: function versionComm(statusList, confirmStatus, refuseStatus, successText, refuseText) {
	...
	createComm: function createComm(selType, type) {
	...
	//初始化
	initialization: function initialization(listType) {
	...
	//创建族库
	bindFamCreateInit: function bindFamCreateInit() {
	...
	//族库初始化
	bindFamInit: function bindFamInit() {
	...
	//族库审核
	bindFamVettedInit: function bindFamVettedInit() {

		App.Console.versionComm(4, 2, 1, "提交审核成功");
	},

	//审核批准
	bindFamAppordInit: function bindFamAppordInit() {
	...
	//发起发版
	bindFamSendVersionInit: function bindFamSendVersionInit() {

		App.Console.versionComm(5, 7, 2, "发版提交成功");
	},

	//族库发版批准
	bindFamSendVersionVettedInit: function bindFamSendVersionVettedInit() {
	...
	//标准模型库
	standardModel: function standardModel() {
	...
	//创建标准模型库
	bindstandardModelCreateInit: function bindstandardModelCreateInit() {
	...
	//标准模型库初始化
	bindstandardModelInit: function bindstandardModelInit() {
	...
	//下拉绑定
	bindSelect: function bindSelect(status, listType) {
	...
	//标准模型状态
	standardModeStatus: function standardModeStatus(versionStatus, confirmStatus, refuseStatus, successText, listType) {
	...
	getUrl2: function getUrl2(status) {
	...
	//标准模型库审核
	bindstandardModelVettedInit: function bindstandardModelVettedInit() {

		App.Console.standardModeStatus(4, 2, 1, "发起成功");
	},

	//标准模型库批准
	bindstandardModelAppordInit: function bindstandardModelAppordInit() {
		App.Console.standardModeStatus(2, 5, 4, "审核成功");
	},


	//标准模型库发版
	bindstandardModelSendVersionInit: function bindstandardModelSendVersionInit() {
		App.Console.standardModeStatus(5, 7, 2, "发起成功");
	},

	//标准模型库发版批准
	bindstandardModelSendVersionVettedInit: function bindstandardModelSendVersionVettedInit() {
	...
	//创建项目
	bindprojectCreateInit: function bindprojectCreateInit() {
		//创建族库
	...
	//项目移交
	bindprojectInit: function bindprojectInit() {
		//标准模型
	...
	//下拉绑定
	bindProjectSelect: function bindProjectSelect(status) {
		//App.Console.initialization();
		$.ajax({
	...
	bindProjectSelect2: function bindProjectSelect2(status) {
		$.ajax({
	...
	//发起审核
	bindprojectVettedInit: function bindprojectVettedInit() {
		App.Console.standardModeStatus(4, 2, 1, "审核成功", 3);
	},

	//审核批准
	bindprojectAppordInit: function bindprojectAppordInit() {
		App.Console.standardModeStatus(2, 5, 4, "审核成功", 3);
	},


	//发起发版
	bindprojectSendVersionInit: function bindprojectSendVersionInit() {
		App.Console.standardModeStatus(5, 7, 2, "发起成功", 3);
	},

	//族库发版批准
	bindprojectSendVersionVettedInit: function bindprojectSendVersionVettedInit() {
		App.Console.standardModeStatus(7, 9, 5, "审核成功", 3);
	},


	//下拉绑定
	bindProjectChangeSelect: function bindProjectChangeSelect(status, listType) {
	...
	getTreeContent: function getTreeContent(projectId, versionId, fileVersionId) {
	...
	//下拉绑定
	bindSelectprojectChange: function bindSelectprojectChange(type, status) {
	...
	//发起
	getProjectChangeUrl: function getProjectChangeUrl(status) {
	...
	getProjectChangeUrl2: function getProjectChangeUrl2(status) {
		var url = "/platform/auditSheet/",
		    //{auditSheet}/approve?approve={approve}
		childAuditSheetNo = $("#famVettedList").val();
	...
	//状态 opType 1 发起 2 审核
	projectChangeStatus: function projectChangeStatus(type, status, opType, successText, subType) {
	...
	//发起变更
	bindprojectChangeCreateInit: function bindprojectChangeCreateInit() {
	...
	//变更批转
	bindprojectChangeInit: function bindprojectChangeInit() {
		App.Console.projectChangeStatus(9, 0, 2, "审批成功");
	},


	// 发起审核
	bindprojectChangeVettedInit: function bindprojectChangeVettedInit() {
		App.Console.projectChangeStatus(9, 1, 1, "发起成功");
	},

	//审核批准
	bindprojectChangeAppordInit: function bindprojectChangeAppordInit() {
		App.Console.projectChangeStatus(10, 0, 2, "审核成功");
	},


	//发起发版
	bindprojectChangeSendVersionInit: function bindprojectChangeSendVersionInit() {
		App.Console.projectChangeStatus(10, 1, 1, "发起成功", 1);
	},

	//族库发版批准
	bindprojectChangeSendVersionVettedInit: function bindprojectChangeSendVersionVettedInit() {
		App.Console.projectChangeStatus(11, 0, 2, "发起成功");
	},


	//算量
	CostAccounting: function CostAccounting() {
		var Settings = App.Console.Settings;
		//发起
		if (Settings.step == 1) {
