    ...
    viewTree:function(options){
      ...
      function renderTree(arr,name,dataType,prefix,isleaf){
        ...
        $.each(arr,function(i,item){
          ...
          // if(_opt.isSelected){
          //  span = '<span class="treeText selected">'+itemName+'('+itemClassCodeNumber+')</span>'
          // }else{
          //   if(_opt.type=='classCode'){
          //     span = '<span class="treeText" title="'+item['code']+'">'+itemName+'('+itemClassCodeNumber+')</span>'
          //   }else if(_opt.name=="specialty"){
          //     span = '<span class="treeText" mcode="'+item['specialtyCode']+'">'+itemName+'('+itemClassCodeNumber+')</span>'
          //   }else{
          //     span = '<span class="treeText">'+itemName+'('+itemClassCodeNumber+')</span>'
          //   }
          // }
          var tmpHtml;
