...
;(function($){
  bimView.comm = {
    ...
    dialog:function(options){
      ...
      var dialog = $('<div class="modelDialog"><div class="dialogBody" style="'+ _opt.width +'px;"><div class="dialogHeader">'+_opt.title+'<span class="dialogClose"></span></div><div class="dialogContent"></div><div class="dialogFooter"><input type="button" class="dialogOk dialogBtn" value="'+_opt.okText+'"/></div></div></div>');
