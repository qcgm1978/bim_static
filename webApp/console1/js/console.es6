App.Console = {
	...
	fam() {
		...
		//发起
		if (Settings.step == 1) {
			var tpl = _.templateUrl('/console1/tpls/fam/create.html', true);
			$("#contains").html(tpl);
			...
			//初始化
			var tpl = _.templateUrl('/console1/tpls/fam/init.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindFamInit();
		} else if (Settings.step == 3) {
			//发起审核
			var tpl = _.templateUrl('/console1/tpls/fam/vetted.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindFamVettedInit();
		} else if (Settings.step == 4) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/fam/approved.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindFamAppordInit();
		} else if (Settings.step == 5) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/fam/sendVersion.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindFamSendVersionInit();
		} else if (Settings.step == 6) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/fam/sendVersionVetted.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
	...
	standardModel() {
		...
		//发起
		if (Settings.step == 1) {
			var tpl = _.templateUrl('/console1/tpls/standardModel/create.html', true);
			$("#contains").html(tpl);
			...
			//初始化
			var tpl = _.templateUrl('/console1/tpls/standardModel/init.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindstandardModelInit();
		} else if (Settings.step == 3) {
			//发起审核
			var tpl = _.templateUrl('/console1/tpls/standardModel/vetted.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindstandardModelVettedInit();
		} else if (Settings.step == 4) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/standardModel/approved.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindstandardModelAppordInit();
		} else if (Settings.step == 5) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/standardModel/sendVersion.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindstandardModelSendVersionInit();
		} else if (Settings.step == 6) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/standardModel/sendVersionVetted.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
	...
	project() {
		...
		//发起
		if (Settings.step == 1) {
			var tpl = _.templateUrl('/console1/tpls/project/create.html', true);
			$("#contains").html(tpl);
			...
			//初始化
			var tpl = _.templateUrl('/console1/tpls/project/init.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindprojectInit();
		} else if (Settings.step == 3) {
			//发起审核
			var tpl = _.templateUrl('/console1/tpls/project/vetted.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindprojectVettedInit();
		} else if (Settings.step == 4) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/project/approved.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindprojectAppordInit();
		} else if (Settings.step == 5) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/project/sendVersion.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindprojectSendVersionInit();
		} else if (Settings.step == 6) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/project/sendVersionVetted.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
	...
	projectChange() {
		...
		//发起
		if (Settings.step == 1) {
			var tpl = _.templateUrl('/console1/tpls/projectChange/create.html', true);
			$("#contains").html(tpl);
			...
			//初始化
			var tpl = _.templateUrl('/console1/tpls/projectChange/init.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindprojectChangeInit();
		} else if (Settings.step == 3) {
			//发起审核
			var tpl = _.templateUrl('/console1/tpls/projectChange/vetted.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindprojectChangeVettedInit();
		} else if (Settings.step == 4) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/projectChange/approved.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindprojectChangeAppordInit();
		} else if (Settings.step == 5) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/projectChange/sendVersion.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
			App.Console.bindprojectChangeSendVersionInit();
		} else if (Settings.step == 6) {
			//审核批准
			var tpl = _.templateUrl('/console1/tpls/projectChange/sendVersionVetted.html', true);
			$("#contains").html(tpl);
			//绑定族库审核
	...
	CostAccounting(){
		...
		//发起
		if (Settings.step == 1) {
			var tpl = _.templateUrl('/console1/tpls/CostAccounting/create.html', true);
			$("#contains").html(tpl); 
			//绑定族库第一步
	...
	qm1(){
		...
		$("#submit").click(function() {
			var data = {
				projectId: 1,
				projectVersionId: $('#versionList').val().trim()

			};
			var param={
				specialty: $("#p1").val().trim(),
				category: $("#p2").val().trim(),
				status: $("#p3").val().trim(),
				name: $("#p4").val().trim(),
				startTime: App.Console.getTime($("#p5").val().trim()),
				endTime:App.Console.getTime($("#p6").val().trim()),
				pageIndex: $("#p7").val().trim(),
				pageItemCount: $("#p8").val().trim()
			};
			//var stringData = JSON.stringify(data);

			$.ajax({
				url: "sixD/1/"+data.projectVersionId+"/device"+App.Console.param(param),
				//data: stringData,
				//headers: {
				//	"Content-Type": "application/json"
				//},
	...
	qm2(){
		...
		$("#submit").click(function() {
			...
			var param={
				...
				category: $("#p2").val().trim(),
				type: $("#p3").val().trim(),
				problemCount: $("#p4").val().trim(),
				pageIndex: $("#p5").val().trim(),
				pageItemCount: $("#p6").val().trim()
			};
			...
			$.ajax({
				url: "sixD/1/"+data.projectVersionId+"/acceptance"+App.Console.param(param),
				//data: stringData,
				//headers: {
				//	"Content-Type": "application/json"
				//},
	...
	qm3(){
		...
		$("#submit").click(function() {
			...
			var param={
				category: $("#p1").val().trim(),
				type: $("#p2").val().trim(),
				status: $("#p3").val().trim(),
				level: $("#p4").val().trim(),
				reporter: $("#p5").val().trim(),
				startTime: App.Console.getTime($("#p6").val().trim()),
				endTime:App.Console.getTime($("#p7").val().trim()),
				pageIndex: $("#p8").val().trim(),
				pageItemCount: $("#p9").val().trim()
			};

			$.ajax({
				url: "sixD/1/"+data.projectVersionId+"/problem"+App.Console.param(param),
				type: "GET"
			}).done(function(data) {
				console.log(data);
				if (data.message == "success") {
	...
	qm4(){
		...
		$("#submit").click(function() {
			...
			var param={
				acceptanceId: $("#p1").val().trim(),
				type: $("#p2").val().trim()

			};

			$.ajax({
				url: "sixD/1/"+data.projectVersionId+"/quality/element"+App.Console.param(param),
				type: "GET"
			}).done(function(data) {
				console.log(data);
				if (data.message == "success") {
	...
	ds1(){
		...
		$("#submit").click(function() {
			...
			var param={
				status: $("#p1").val().trim(),
				specialty: $("#p2").val().trim(),
				type: $("#p3").val().trim(),
				reporter: $("#p4").val().trim(),
				pageIndex: $("#p5").val().trim(),
				pageItemCount: $("#p6").val().trim()
			};
			//var stringData = JSON.stringify(data);
			...
			$.ajax({
				url: "sixD/1/"+data.projectVersionId+"/design/check"+App.Console.param(param),
				type: "GET"
			}).done(function(data) {
				console.log(data);
				if (data.message == "success") {
